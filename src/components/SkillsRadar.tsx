...
export default function SkillsRadar() {
  ...
  const skillsData = [
    ...
    { name: 'Wireshark (Net Sec)', category: 'tools', level: 80 },
    { name: 'VirtualBox (Sandboxing)', category: 'tools', level: 85 },
    { name: 'Data Structures & Algos', category: 'tools', level: 86 },
    { name: 'OOP Concepts', category: 'tools', level: 90 },
    { name: 'REST APIs', category: 'tools', level: 88 },
    { name: 'Agile & Scrum', category: 'tools', level: 82 },
  ];
